...
export async function fetchTasks(params?: Omit<TaskQueryParams, 'groupBy'>): Promise<Task[]> {
  return get<Task[]>('/tasks', params as Record<string, string | number | boolean | undefined>)
}
