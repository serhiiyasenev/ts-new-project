import { User, CreateUserDto, UpdateUserDto, UserQueryParams } from '@shared/user.types'
import { get, post, put, del } from './client'

export async function fetchUsers(params?: UserQueryParams): Promise<User[]> {
  return get<User[]>('/users', params as Record<string, string | number | boolean | undefined>)
}
